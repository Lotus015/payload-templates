# Traditional Law Firm Template

A professional law firm website template featuring a Burgundy (#800020) and Gold color scheme with Merriweather and Lora fonts.
...
- `--traditional-burgundy`: Primary burgundy color
- `--traditional-gold`: Accent gold color
- `--traditional-cream`: Background cream color
