        ...
        <div className="grid gap-12 lg:grid-cols-2 lg:gap-16 items-center">
          ...
          <div className="relative">
            {image?.url ? (
              ...
              <div className="relative aspect-[4/3] rounded-lg overflow-hidden shadow-xl bg-gradient-to-br from-burgundy to-burgundy-light flex items-center justify-center">
