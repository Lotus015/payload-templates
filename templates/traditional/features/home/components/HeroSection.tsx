  ...
  return (
    <section className="relative min-h-[600px] lg:min-h-[700px] flex items-center">
      ...
      {backgroundImage?.url ? (
        ...
        <div className="absolute inset-0 z-0 bg-gradient-to-br from-burgundy via-burgundy-light to-burgundy-dark" />
      )}
        ...
        <div className="max-w-3xl">
          ...
          <div className="mt-10 flex flex-col gap-4 sm:flex-row sm:gap-6">
            <Button
              asChild
              size="lg"
              className="bg-gold text-burgundy hover:bg-gold-light font-semibold"
            >
