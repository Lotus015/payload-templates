...
export const metadata: Metadata = {
  title: 'About Us | Modern Law Firm',
  description:
...
async function getAboutData() {
  try {
    ...
    return {
      team,
      firmName: siteSettings.firmName as string || 'Modern Law Firm',
    }
  } catch {
    return {
      team: [],
      firmName: 'Modern Law Firm',
    }
  }
}
        ...
        <div className="container mx-auto px-4">
          <div className="grid gap-12 lg:grid-cols-2 lg:gap-16 items-center">
            ...
            <div className="relative">
              <div className="relative aspect-[4/3] rounded-lg overflow-hidden shadow-xl bg-gradient-to-br from-slate-900 to-slate-700 flex items-center justify-center">
                <div className="text-center text-slate-300 p-8">
                  <div className="w-24 h-24 mx-auto mb-4 rounded-full bg-blue-500/20 flex items-center justify-center">
                    <span className="font-heading text-4xl font-bold text-blue-400">
              ...
              <div className="absolute -bottom-4 -right-4 w-24 h-24 bg-blue-500/20 rounded-lg -z-10 hidden lg:block" />
              <div className="absolute -top-4 -left-4 w-32 h-32 border-2 border-blue-500/30 rounded-lg -z-10 hidden lg:block" />
            </div>
                  ...
                  <div className="relative aspect-[4/3]">
                    {member.photo?.url ? (
                      ...
                      <div className="absolute inset-0 bg-gradient-to-br from-slate-900 to-slate-700 flex items-center justify-center">
                        <span className="font-heading text-3xl font-bold text-blue-400/50">
                          {member.name
                            .split(' ')
                            .map((n) => n[0])
                            .join('')}
