...
export async function generateMetadata({
  ...
  return {
    title: `${service.title} | Modern Law Firm`,
...
export default async function ServicePage({ params }: ServicePageProps) {
  ...
  return (
    <MainLayout>
      ...
      {/* Hero Section */}
      <section className="bg-blue py-16 lg:py-24">
        <div className="container mx-auto px-4">
          <div className="max-w-3xl">
            <div className="mb-6 w-16 h-16 rounded-lg bg-white flex items-center justify-center">
            ...
            <div className="mt-8">
              <Button
                asChild
                size="lg"
                className="bg-white text-blue hover:bg-gray"
              >
                <Link href="/contact">
                  ...
                  <nav className="space-y-2">
                    {otherServices.map((otherService) => {
                      ...
                      return (
                        ...
                        >
                          <div className="w-8 h-8 rounded bg-blue/10 flex items-center justify-center group-hover:bg-blue transition-colors">
                            <OtherIcon className="h-4 w-4 text-blue group-hover:text-white transition-colors" />
                          </div>
                          <span className="text-sm font-medium group-hover:text-blue transition-colors">
                            {otherService.title}
                          </span>
                        </Link>
                      )
