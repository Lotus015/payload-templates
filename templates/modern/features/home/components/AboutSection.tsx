        ...
        <div className="grid gap-12 lg:grid-cols-2 lg:gap-16 items-center">
          ...
          <div className="relative">
            {image?.url ? (
              ...
              <div className="relative aspect-[4/3] rounded-lg overflow-hidden shadow-xl bg-gradient-to-br from-blue to-blue-light flex items-center justify-center">
            ...
            {/* Decorative accent */}
            <div className="absolute -bottom-4 -right-4 w-24 h-24 bg-blue/20 rounded-lg -z-10 hidden lg:block" />
            <div className="absolute -top-4 -left-4 w-32 h-32 border-2 border-blue/30 rounded-lg -z-10 hidden lg:block" />
          </div>

          {/* Content Column */}
          <div>
            <p className="text-blue font-semibold uppercase tracking-wider text-sm mb-2">
              {subtitle}
            </p>
            ...
            <ul className="space-y-3 mb-8">
              {features.map((feature, index) => (
                <li key={index} className="flex items-start gap-3">
                  <CheckCircle className="h-5 w-5 text-blue mt-0.5 shrink-0" />
