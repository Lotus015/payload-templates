...
export async function generateMetadata({
  ...
  return {
    title: `${service.title} | Boutique Law Firm`,
      ...
      <section className="bg-green py-16 lg:py-24">
        <div className="container mx-auto px-4">
          <div className="max-w-3xl">
            <div className="mb-6 w-16 h-16 rounded-lg bg-beige flex items-center justify-center">
            ...
            <div className="mt-8">
              <Button
                asChild
                size="lg"
                className="bg-beige text-green hover:bg-beige-light"
              >
                <Link href="/contact">
                  ...
                  <nav className="space-y-2">
                    {otherServices.map((otherService) => {
                      ...
                      return (
                        ...
                        >
                          <div className="w-8 h-8 rounded bg-green/10 flex items-center justify-center group-hover:bg-green transition-colors">
                            <OtherIcon className="h-4 w-4 text-green group-hover:text-beige transition-colors" />
                          </div>
                          <span className="text-sm font-medium group-hover:text-beige transition-colors">
                            {otherService.title}
                          </span>
                        </Link>
                      )
