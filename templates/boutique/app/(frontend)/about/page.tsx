...
export const metadata: Metadata = {
  title: 'About Us | Boutique Law Firm',
  description:
...
async function getAboutData() {
  try {
    ...
    return {
      team,
      firmName: siteSettings.firmName as string || 'Boutique Law Firm',
    }
  } catch {
    return {
      team: [],
      firmName: 'Boutique Law Firm',
    }
  }
}
      ...
      <section className="bg-green py-16 lg:py-24">
        <div className="container mx-auto px-4">
          <div className="max-w-3xl">
            <p className="text-cream font-semibold uppercase tracking-wider text-sm mb-4">
              About Our Firm
            </p>
            ...
            <div className="relative">
              <div className="relative aspect-[4/3] rounded-lg overflow-hidden shadow-xl bg-gradient-to-br from-green to-green-light flex items-center justify-center">
                <div className="text-center text-cream/80 p-8">
                  <div className="w-24 h-24 mx-auto mb-4 rounded-full bg-beige/20 flex items-center justify-center">
                    <span className="font-heading text-4xl font-bold text-beige">
              ...
              <div className="absolute -bottom-4 -right-4 w-24 h-24 bg-green/20 rounded-lg -z-10 hidden lg:block" />
              <div className="absolute -top-4 -left-4 w-32 h-32 border-2 border-green/30 rounded-lg -z-10 hidden lg:block" />
            </div>
              ...
              <Card key={index} className="text-center">
                <CardContent className="pt-6">
                  <div className="w-12 h-12 mx-auto mb-4 rounded-full bg-green/10 flex items-center justify-center">
                    <value.icon className="h-6 w-6 text-green" />
                  </div>
                  ...
                  <div className="relative aspect-[4/3]">
                    {member.photo?.url ? (
                      ...
                      <div className="absolute inset-0 bg-gradient-to-br from-green to-green-light flex items-center justify-center">
                        <span className="font-heading text-3xl font-bold text-beige/50">
                          {member.name
                            .split(' ')
                            .map((n) => n[0])
                            .join('')}
      ...
      <section className="py-16 lg:py-24 bg-green">
        <div className="container mx-auto px-4 text-center">
          ...
          <Button
            asChild
            size="lg"
            className="bg-beige text-green hover:bg-cream font-semibold"
          >
