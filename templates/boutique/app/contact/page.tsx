...
export const metadata: Metadata = {
  title: 'Contact Us | Boutique Law Firm',
  description:
          ...
          <div className="max-w-3xl mx-auto text-center">
            ...
            <div className="grid gap-8 md:grid-cols-3 text-left">
              <div className="p-6 bg-background rounded-lg shadow-sm">
                <div className="w-10 h-10 rounded-full bg-green flex items-center justify-center mb-4">
                  <span className="text-beige font-bold">1</span>
                </div>
              ...
              <div className="p-6 bg-background rounded-lg shadow-sm">
                <div className="w-10 h-10 rounded-full bg-green flex items-center justify-center mb-4">
                  <span className="text-beige font-bold">2</span>
                </div>
                <h3 className="font-heading font-semibold mb-2">
                  Consultation
                </h3>
              ...
              <div className="p-6 bg-background rounded-lg shadow-sm">
                <div className="w-10 h-10 rounded-full bg-green flex items-center justify-center mb-4">
                  <span className="text-beige font-bold">3</span>
                </div>
