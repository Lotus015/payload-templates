...
export async function generateMetadata({
  ...
  return {
    title: `${post.title} | Boutique Law Firm Blog`,
...
export default async function BlogPostPage({ params }: BlogPostPageProps) {
  ...
  return (
    <MainLayout>
      ...
      <article>
        {/* Hero Section */}
        <header className="bg-green py-16 lg:py-20">
            ...
            <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3 max-w-5xl mx-auto">
              {relatedPosts.map((relatedPost) => (
                ...
                >
                  <div className="relative aspect-[16/10] overflow-hidden">
                    {relatedPost.featuredImage?.url ? (
                      ...
                      <div className="absolute inset-0 bg-gradient-to-br from-green to-green-light flex items-center justify-center">
                        <span className="font-heading text-xl font-bold text-beige/50">
                          Blog
                        </span>
                      </div>
                    )}
                  ...
                  <CardContent>
                    <CardTitle className="font-heading text-lg group-hover:text-green transition-colors">
