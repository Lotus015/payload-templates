# Boutique Law Firm Template - Operating Contract

## Project Overview

This is the Boutique law firm website template built with:
...
- **Primary Color:** Deep Green (#2c5f2d) - HSL 122 37% 27%
- **Accent Color:** Beige (#e8dcc4) - HSL 40 45% 84%
- **Background:** Cream (#faf7f2)
- **Heading Font:** Cormorant
- **Body Font:** Raleway
- **Style:** Elegant, specialized aesthetic with natural tones
...
- `--boutique-green` - Primary green color
- `--boutique-beige` - Accent beige color
- `--boutique-cream` - Background cream color

Tailwind utility classes:
- `bg-green`, `text-green`, `border-green`
- `bg-beige`, `text-beige`, `border-beige`
- `bg-cream`, `text-cream`
