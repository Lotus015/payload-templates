...
export async function generateMetadata({
  ...
  return {
    title: `${service.title} | Premium Law Firm`,
                  ...
                  <nav className="space-y-2">
                    {otherServices.map((otherService) => {
                      ...
                      return (
                        ...
                        >
                          <div className="w-8 h-8 rounded bg-navy/10 flex items-center justify-center group-hover:bg-navy transition-colors">
                            <OtherIcon className="h-4 w-4 text-navy group-hover:text-gold transition-colors" />
                          </div>
