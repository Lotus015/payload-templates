...
export const metadata: Metadata = {
  title: 'About Us | Premium Law Firm',
  description:
...
async function getAboutData() {
  try {
    ...
    return {
      team,
      firmName: siteSettings.firmName as string || 'Premium Law Firm',
    }
  } catch {
    return {
      team: [],
      firmName: 'Premium Law Firm',
    }
  }
}
        ...
        <div className="container mx-auto px-4">
          <div className="grid gap-12 lg:grid-cols-2 lg:gap-16 items-center">
            ...
            <div className="relative">
              <div className="relative aspect-[4/3] rounded-lg overflow-hidden shadow-xl bg-gradient-to-br from-navy to-navy-light flex items-center justify-center">
